...
<body>
    ...
    <article>
        ...
        <section id="result">
            <h2>Resultat</h2>
            <p>Du kan endre på kalenderen! Det er ikke mulig å ha mer enn 7 dager i uka.</p>
            ...
            <div class="row input-field">
                ...
                <input type="number" id="o11-cal-week" class="col s4" max="7" min="1" value="7">
            </div>
            <div id="calendar"></div>
            <script>
                window.onload = ready;
                ...
                function ready() {
                    ...
                    setCalendar(daysInMonth.value, weekStart.value, daysInWeek.value);

                    weekStart.oninput = function(){
                        setCalendar(daysInMonth.value, this.value, daysInWeek.value)
                    };

                    daysInMonth.oninput = function(){
                        setCalendar(this.value, weekStart.value, daysInWeek.value)
                    };

                    daysInWeek.oninput = function(){
                        setCalendar(daysInMonth.value, weekStart.value, this.value)
                    };
                }

                function setCalendar(daysInMonth, weekStart, daysInWeek) {
                    ...
                    for (var i = 1; i <= daysInMonth; i++) {
                        ...
                        // Avslatt og lag en ny rad for hver gjeldene dag er delelig med antall dager i uka
